...
print("Years in optimal case where T < 1.6 deg C: {}".format(times[b0_t <= 1.6] + 2025))
print("Years in baseline 2 where T < 1.6 deg C: {}".format(times[b1_t <= 1.6] + 2025))
print("Years in baseline 3 where T < 1.6 deg C: {}".format(times[b2_t <= 1.6] + 2025))
print("Years in baesline 4 where T < 1.6 deg C: {}".format(times[b3_t <= 1.6] + 2025))


print("Years in optimal case where T >= 1.7 deg C: {}".format(times[b0_t >= 1.699] + 2025))
print("Years in baseline 2 where T >= 1.7 deg C: {}".format(times[b1_t >= 1.699] + 2025))
print("Years in baseline 3 where T >= 1.7 deg C: {}".format(times[b2_t >= 1.699] + 2025))
print("Years in baesline 4 where T >= 1.7 deg C: {}".format(times[b3_t >= 1.699] + 2025))
